...
masterInfoTiles: InfoTile[] = [
  new InfoTile('./assets/trade-it.jpg', './assets/blockTradeItIn.png', 'Trade in your used Patagonia gear at any Patagonia retail location and receive credit to put toward another new or used garment.', '#'),
